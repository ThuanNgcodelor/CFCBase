...
public record HrRosterResponse(
    ...
    public static HrRosterResponse from(HrMonthlyRoster roster) {
        return new HrRosterResponse(
                ...
                roster.getStatus(),
                roster.getItemCount(),
                roster.getSourceRoster() == null ? null : roster.getSourceRoster().getId(),
                roster.getSourceRoster() == null ? null : roster.getSourceRoster().getPeriodStart(),
                roster.getSourceImportBatch() != null,
                roster.getRosterChecksum(),
                roster.getOpenedAt(),
