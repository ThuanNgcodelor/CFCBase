...
export default function HrRosterDetail() {
  ...
  return (
      ...
      <div className="mb-4"><HrReadOnlyNotice>Danh sách này được tính tự động từ dữ liệu nền T6-26 và các Tăng/Giảm đã xác nhận theo ngày hiệu lực. Thay đổi một biến động trong tháng cũ sẽ tự ảnh hưởng tháng đó và các tháng sau.</HrReadOnlyNotice></div>
