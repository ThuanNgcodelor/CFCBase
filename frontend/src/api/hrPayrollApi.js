...
export const hrPayrollApi = {
  ...
  createCampaign: async (id, selectionMode = 'ALL_ELIGIBLE', rowIds = []) => unwrapApiData(await baseApi.post(`/hr/payroll/imports/${id}/campaigns`, { deliveryMode: 'TEXT', selectionMode, rowIds })),
