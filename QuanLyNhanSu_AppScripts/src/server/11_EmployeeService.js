...
var HrEmployeeService = (function () {
  ...
  var EDITABLE_FIELDS_ = [
    ...
    'contract_type_code', 'contract_number', 'base_salary', 'allowance',
    'job_description', 'education_level', 'major', 'leave_days',
    'display_order', 'department_display_order',
    ...
    'social_insurance_start_date', 'medical_registration_place',
